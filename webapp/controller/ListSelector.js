sap.ui.define([
		...
		return BaseObject.extend("zm209_chng_req.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zm209_chng_req.controller.ListSelector
			 */
			 ...
			 * @public
			 */
			setBoundMasterList : function (oList,oFilter) {
				this._oList = oList;
				this._fnResolveListHasBeenSet(oList,oFilter);
			},
			 ...
			 * @return {zm209_chng_req.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
			...
			/**
			 * This will make the promise to null to initiate it again when user moves back
			 * @public
			 */
